# 2.2-Creating Groups & Frequency Distributions
...
## 2.2.4 Calculate Absolute Grouped Frequencies with RFS Method
...
## 2.2.5 RFS 1. Roll it up with .rollups()!
...
## 2.2.6 RFS 2. Flatten that `.rollups()` output with `.flatMap()`
...
## 2.2.7 RFS 3. Sum it up with D3's .sum()!
